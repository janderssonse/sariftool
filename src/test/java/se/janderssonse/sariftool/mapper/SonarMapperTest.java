...
class SonarMapperTest {
        ...
        void testMapperInjected() {
                ...
                Optional<String> org = Optional.of("org");
                Optional<String> version = Optional.of("version");

                RuleProperties properties = createRuleProperties(Severity.error);
                final SonarMapper testee = new SonarMapper();
                testee.setDriver(new Driver(name, org, version));
                ...
                assertEquals(
                                String.format("%s %s v%s", org.get(), name.get(), version.get()),
                                issue.engineId().get());
        }
